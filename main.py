# importacoes das libs que serão utilizadas no projeto.
...
credentials= ['Brenda', '123456']

# funcão de verificar login
...
label_line = Label(frame_up, text='', width=275, anchor=NW, font=('Ivy', 1, 'bold'), bg=cor2, fg=cor4)
label_line.place(
    x=10,
    y=45
)
